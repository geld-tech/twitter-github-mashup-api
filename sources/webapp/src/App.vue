<template>
  <div id="app">
    <!-- Navigation -->
    <b-navbar class="navbar-expand-lg navbar-light bg-white fixed-top">
      <b-navbar-brand href="/">
      ...
      <b-navbar-nav class="ml-auto">
        <b-nav-form @submit="onSubmit" @reset="onReset">
          <b-form-input id="searchInput" type="search"  v-model="form.keyword" class="form-control mr-sm-2" placeholder="" aria-label="Search"></b-form-input>
